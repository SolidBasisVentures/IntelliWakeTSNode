...
export declare const PaginatorResponseFromRequestCount: <SORT = Record<string, any>, FILTER = Record<string, any>>(paginatorRequest: IPaginatorRequest<SORT, FILTER>, rowCount: number) => IPaginatorResponse<Record<string, any>>;
