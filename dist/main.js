...
var PGTable = /** @class */ (function () {
    ...
    PGTable.prototype.tsText = function () {
        ...
        if (this.inherits.length > 0) {
            for (var _i = 0, _h = this.inherits; _i < _h.length; _i++) {
                var inherit = _h[_i];
        ...
        if (enums.length > 0) {
            for (var _j = 0, enums_1 = enums; _j < enums_1.length; _j++) {
                var enumItem = enums_1[_j];
            ...
            if (pgColumn.array_dimensions.length > 0) {
                ...
                if (!pgColumn.blobType()) {
                    if (intelliwaketsfoundation.IsOn(pgColumn.is_identity) && pgColumn.isAutoIncrement) {
                        ...
                        else if (((_d = pgColumn.column_default) !== null && _d !== void 0 ? _d : '').toString().includes('::')) {
                            text += '\'' + ((_e = pgColumn.column_default) !== null && _e !== void 0 ? _e : '').toString().substring(0, ((_f = pgColumn.column_default) !== null && _f !== void 0 ? _f : '').toString().indexOf('::') - 1) + '\'';
                        }
                        else {
                            text += '\'' + ((_g = pgColumn.column_default) !== null && _g !== void 0 ? _g : '') + '\'';
                        }
                    }
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 1:
                    ...
                    for (_i = 0, columns_1 = columns; _i < columns_1.length; _i++) {
                        column = columns_1[_i];
                        pgColumn = new PGColumn(__assign(__assign({}, column), { isAutoIncrement: intelliwaketsfoundation.IsOn(column.identity_increment), udt_name: column.udt_name.toString().startsWith('_') ? column.udt_name.toString().substr(1) : column.udt_name, array_dimensions: column.udt_name.toString().startsWith('_') ? [null] : [], column_default: ((_c = column.column_default) !== null && _c !== void 0 ? _c : '').toString().startsWith("'NULL'") ? null : ((_d = column.column_default) !== null && _d !== void 0 ? _d : '').toString().startsWith("''::") ? '' : column.column_default }));
                        pgTable.columns.push(pgColumn);
                    }
